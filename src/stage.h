...
typedef enum
{
	StageId_1_1, //Phantasm
	StageId_1_2, //Phantasm Monika Ver
	
	StageId_1_1Multi, //Phantasm
	StageId_1_2Multi, //Phantasm Monika Ver
...
{
	//Stage settings
	boolean ghost, downscroll, expsync, movecamera, botplay;
	s32 mode;
